...
type websocketServer struct {
	...
	reportChan chan []byte	// node的报告都塞到这个chan
	commandChan chan []byte	// 前端UI给的指令都写到这个chan
...
func StartWebSocketServer(addr string, reportChan chan []byte, commandChan chan []byte) error {
